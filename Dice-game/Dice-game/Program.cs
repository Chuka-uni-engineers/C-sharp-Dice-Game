...
switch (pressedKey.Key)
{
    case ConsoleKey.R:
        ...
        System.Threading.Thread.Sleep(200); Console.Write("Christine "); System.Threading.Thread.Sleep(200); Console.Write("Awour ");
        System.Threading.Thread.Sleep(200); Console.WriteLine("<3.");
...
else if (players == 3)
{
    ...
    } while (String.IsNullOrEmpty(player3));
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        Console.ReadKey(true);
        Console.WriteLine();
        player3RandomNum = random.Next(1, 7);
        System.Threading.Thread.Sleep(500);
        Console.WriteLine("...");
...
else
{
    ...
    } while (String.IsNullOrEmpty(player4));
    ...
    for (int i = 0; i < 6; i++)
    {
        ...
        Console.ReadKey(true);
        Console.WriteLine();
        player4RandomNum = random.Next(1, 7);
        System.Threading.Thread.Sleep(500);
        Console.WriteLine("...");
